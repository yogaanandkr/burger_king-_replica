              ...
              >
                <g clip-path="url(#a)">
                  ...
                  <path
                    fill="url(#b)"
                    fill-rule="evenodd"
                    d="M14.625 10.547c-.406.437-.64 1.104-.64 1.976v30.958c0 .872.234 1.54.654 1.958l.108.094L32.112 28.19V27.8l-17.38-17.348-.107.094Z"
                    clip-rule="evenodd"
                  ></path>
                  <path
                    fill="url(#c)"
                    fill-rule="evenodd"
                    d="m37.89 33.988-5.792-5.785v-.405l5.791-5.785.126.076 6.851 3.89c1.961 1.103 1.961 2.925 0 4.043l-6.85 3.889-.127.077Z"
                    clip-rule="evenodd"
                  ></path>
                  <path
                    fill="url(#d)"
                    fill-rule="evenodd"
                    d="M38.015 33.91 32.098 28 14.624 45.453c.64.684 1.713.761 2.912.094l20.48-11.636Z"
                    clip-rule="evenodd"
                  ></path>
                  <path
                    fill="url(#e)"
                    fill-rule="evenodd"
                    d="M38.015 22.09 17.536 10.47c-1.199-.684-2.275-.59-2.912.095L32.099 28l5.917-5.91Z"
                    clip-rule="evenodd"
                  ></path>
                  <path
                    fill="#000"
                    fill-rule="evenodd"
                    d="M37.89 33.785 17.55 45.327c-1.136.653-2.15.607-2.803.014l-.109.108.109.094c.653.59 1.667.64 2.803-.014L38.03 33.91l-.14-.125Z"
                    clip-rule="evenodd"
                    opacity="0.2"
                  ></path>
                  <path
                    fill="#000"
                    fill-rule="evenodd"
                    d="m44.866 29.819-6.994 3.966.126.126 6.85-3.89c.983-.558 1.465-1.291 1.465-2.021-.06.67-.559 1.306-1.447 1.819Z"
                    clip-rule="evenodd"
                    opacity="0.12"
                  ></path>
                  <path
                    fill="#fff"
                    fill-rule="evenodd"
                    d="m17.536 10.673 27.33 15.508c.888.5 1.388 1.152 1.465 1.82 0-.73-.483-1.463-1.465-2.022L17.536 10.47c-1.96-1.121-3.551-.185-3.551 2.053v.202c0-2.241 1.59-3.16 3.551-2.053Z"
                    clip-rule="evenodd"
                    opacity="0.25"
                  ></path>
                </g>
                <defs>
                  ...
                  <clipPath id="a">
                    <path fill="#fff" d="M0 0h190v56H0z"></path>
                  </clipPath>
                </defs>
              </svg>
            </div>
