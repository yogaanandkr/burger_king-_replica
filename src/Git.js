...
function Git({ data: a }) {
  ...
  //   }
  // ]`
  // console.log("from git.js", data.data);
  return (
    <>
      {a.map(a => (
        <Card className="card" style={{ width: "18rem" }} key={a.id}>
          <Card.Img className="card_img" variant="top" src={a.avatar_url} />
          <Card.Body>
            <Card.Title>{a.login}</Card.Title>
            {/* <Card.Text>{a.events_url}</Card.Text> */}
